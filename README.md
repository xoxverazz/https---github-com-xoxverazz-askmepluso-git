...
| `anas-samosa-database.sql` | MySQL schema + all product & order data |
| `README.md` | This file |
...
mysql -u root -p < anas-samosa-database.sql
```
...
---
© 2024 Anas Samosa · Powered by [ShopEZ](https://shopez.app)
